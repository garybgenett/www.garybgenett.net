...
override COMPOSER_EXPORTS := CNAME README .nojekyll .composer.mk .composer.yml *.html *.pdf *.epub *.revealjs.html *.docx *.pptx *.txt *.md.txt
override COMPOSER_IGNORES := Composer.export 404.md index.md resume writing
override c_site := 1
